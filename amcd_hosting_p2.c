 ...
 * Description: This program written for AMCD Hosting Inc.
    * is part two of a monthly billing program. The features
    * added in this part include email, internet marketing, and
    * a more robust input validation system.
...
// NEW FEATURE! - Email Marketing Package Costs
...
// NEW FEATURE! - Internet Marketing Package Costs
...
int main(void)
{
    ...
    // NEW FEATURE! - Email Marketing Variables
    ...
    // NEW FEATURE! - Internet Marketing Variables
    ...
    /* *NEW FEATURE: There is now a more robust input validation system
        * that ensures the user inputs 'Y' or 'N' correctly.*/
    ...
    // Validate user's Y/N choice for Web Hosting Service
    do {
